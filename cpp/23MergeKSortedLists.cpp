...
public:
    ListNode* mergeKLists(vector<ListNode*>& lists) {
        using GreaterFunc = function<bool(ListNode*, ListNode*)>;
        GreaterFunc greaterFunc = [](ListNode* n1, ListNode* n2) {
            return n1->val > n2->val;
        };
        priority_queue<ListNode*, vector<ListNode*>, GreaterFunc> pq(
            greaterFunc);
